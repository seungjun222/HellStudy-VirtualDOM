...
var createVApp = function createVApp(count) {
  return (0, _createElement.default)('div', {
    ...
    children: [(0, _createElement.default)('input'), String(count)].concat(_toConsumableArray(Array.from({
      length: count
    }, function () {
...
setInterval(function () {
  var vNewApp = createVApp(Math.floor(Math.random() * 10));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "1919" + '/');
